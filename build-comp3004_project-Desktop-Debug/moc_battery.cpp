...
#include <memory>
#include "../comp3004_project/battery.h"
...
QT_MOC_LITERAL(1, 8, 14), // "batteryChanged"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 6), // "charge"
QT_MOC_LITERAL(4, 31, 10) // "lowBattery"

    },
    "Battery\0batteryChanged\0\0charge\0"
    "lowBattery"
};
...
void Battery::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->batteryChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->lowBattery(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Battery::batteryChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Battery::lowBattery)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Battery::batteryChanged(int _t1)
{
