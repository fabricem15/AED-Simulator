...
QT_MOC_LITERAL(1, 8, 16), // "batteryDecreased"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 6) // "charge"

    },
    "Battery\0batteryDecreased\0\0charge"
};
...
void Battery::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->batteryDecreased((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Battery::batteryDecreased)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Battery::batteryDecreased(int _t1)
{
