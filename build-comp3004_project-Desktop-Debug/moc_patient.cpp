...
#include <memory>
#include "../comp3004_project/patient.h"
...
QT_MOC_LITERAL(1, 8, 9), // "newRhythm"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 6), // "string"
QT_MOC_LITERAL(4, 26, 1), // "r"
QT_MOC_LITERAL(5, 28, 11), // "handleShock"
QT_MOC_LITERAL(6, 40, 9) // "handleCPR"

    },
    "Patient\0newRhythm\0\0string\0r\0handleShock\0"
    "handleCPR"
};
...
void Patient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->newRhythm((*reinterpret_cast< string(*)>(_a[1]))); break;
        case 1: _t->handleShock(); break;
        case 2: _t->handleCPR(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Patient::*)(string );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Patient::newRhythm)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Patient::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Patient.data,
    qt_meta_data_Patient,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void Patient::newRhythm(string _t1)
{
